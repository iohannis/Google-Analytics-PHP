...
try {
    ...
    foreach($props['items'] as $item) {
        ...
        $output_body .= '<li class="profile-'.$item['id'].' '.$row_class.' clearfix">';
		...
		$output_body .= ' <a href="report.php?profile='.$item['id'].'&report=latest-keywords" target="_blank" class="report-item keywords link">[keywords]</a>';
